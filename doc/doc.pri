...
qt:greaterThan(QT_MAJOR_VERSION, 4) {
    ...
    QDOC_MAINFILE = $$PWD/sqldatabase.qdocconf
} else {
...
QHP_FILE = $$HTML_DOC_PATH/sqldatabase.qhp
QCH_FILE = $$OUT_PWD/doc/sqldatabase.qch

HELP_DEP_FILES = $$PWD/src/qml-sqldatabase.qdoc \
                 $$PWD/src/sqldatabase-example.qdoc \
                 $$PWD/src/sqldatabase.qdoc \
                 $$QDOC_MAINFILE
...
inst_qch_docs.path = $$[QT_INSTALL_DOCS]/sqldatabase
